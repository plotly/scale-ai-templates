...
# Define the prompt
desc = "Our decking products have three different material: twenty tiles, fourteen wood, 3 composite more than the number of wood we have."
code_exp = "px.bar(x=['tile', 'wood', 'composite'], y=[20, 14, 23], labels=dict(x='material', y='count'), title='Decking Products')"
